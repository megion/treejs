    ...
    var self =
    {
        ...
        init: function()
        {
            ...
            if(!this.containerDiv)
            {
                ...
                var cssHeight = "height:" + (this.logHeight + this.tabHeight) + "px; ";
                ...
                cssHeight = "height:" + (this.logHeight - 11) + "px; ";         // subtract paddings and border-top
        ...
        print: function(msg)
        {
            ...
            if(typeof msg == "undefined")   // print a blank line if no param
            {
                msg = "";
            }
            else
            ...
            for(var i in lines)
            {
                ...
                var span = document.createElement("span");  // color for time
                ...
                this.logDiv.appendChild(span);      // add time
                this.logDiv.appendChild(textNode);  // add message
